<template>
    <div class="comment" v-if="evaluation">
        ...
        <div class="shop-info">
            <!--            标签-->
            <ul class="tags">
                <li :class="{'unsatisfied':item.unsatisfied}" v-for="(item,index) of evaluation.tags" :key="index">
                    {{item.name}}
            ...
            <ul class="comments-wrap">
                <li v-for="(item,index) in evaluation.comments" :key="index">
                    ...
                    <div class="comments-info">
                        ...
                        <div class="comment-text">{{item.comment_text||'该用户未编写评价，系统默认好评'}}</div>
    ...
    export default {
        ...
        methods: {
            ...
            ratingcontent(rating) {
                ...
                return content[rating-1] //这里没有小数
            }
        }
    }
</script>
