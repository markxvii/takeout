            ...
            >
                ...
                <div class="order-card-content">
                    ...
                    <div class="order-card-detail">
                        <p class="detail" v-if="order.hasOwnProperty('orderInfo') && order.orderInfo.hasOwnProperty('selectFoods') && order.orderInfo.selectFoods.length>0 && order.orderInfo.selectFoods[0].name.length>0">{{order.orderInfo.selectFoods[0].name}}</p>
