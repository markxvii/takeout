<template>
    <div class="rst-activity">
        ...
        <transition name="fade">
            <div class="act_model" v-show="showSheet">
                <div class="activity-sheet">
                    ...
                    <ul>
                        <li v-for="(item,index) of activities" :key="index">
                            <span :style="{background:'#'+item.icon_color}">{{activities[0].icon_name}}</span>
