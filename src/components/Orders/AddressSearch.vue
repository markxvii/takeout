    ...
    <div v-if="showSearch" class="addressSearch">
        <div class="search-view">
            ...
            <ul class="search-list">
                <li @click="selectAddress(item)" v-for="(item,index) of areaList" :key="index" class="search-row">
...
<script>
    export default {
        name: "AddressSearch",
        props: {
            showSearch: Boolean, //显示开关
            addressInfo:Object //整个地址表单内容
        },
        data() {
            return {
                search_address: "",
